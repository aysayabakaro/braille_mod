        ...
        function (e, t, n) {
            ...
            (h.recalculateRGB = function (e, t, n) {
                if ("HEX" === e.__state.space)
                    e.__state[t] = d["default"].component_from_hex(
                        e.__state.hex,
                        n
                    );
                else {
                ...
                (h.recalculateHSV = function (e) {
                    ...
                    p["default"].extend(e.__state, { s: t.s, v: t.v }),
                        p["default"].isNaN(t.h)
                            ? p["default"].isUndefined(e.__state.h) &&
                              (e.__state.h = 0)
                            : (e.__state.h = t.h);
                }),
            ...
            var s = n(12),
                ...
                p = (function (e) {
                    ...
                    return (
                        a(t, e),
                        (t.prototype.updateDisplay = function () {
                            return c["default"].isActive(this.__input)
                                ? this
                    ...
                    function t(n, o) {
                        ...
                        function h(e) {
                            ...
                            var t = y.__saturation_field.getBoundingClientRect(),
                                ...
                                o =
                                    1 -
                                    (e.clientY - t.top) / (t.bottom - t.top);
                            return (
                                o > 1 ? (o = 1) : o < 0 && (o = 0),
                                n > 1 ? (n = 1) : n < 0 && (n = 0),
                                (y.__color.v = o),
                        ...
                        (v.domElement = document.createElement("div")),
                            ...
                            (v.__saturation_field = document.createElement(
                                "div"
                            )),
                            (v.__saturation_field.className =
                                "saturation-field"),
                        ...
                        return (
                            ...
                            g["default"].extend(v.__input.style, {
                                ...
                                fontWeight: "bold",
                                textShadow:
                                    v.__input_textShadow + "rgba(0,0,0,0.7)",
                            }),
                            f["default"].bind(
                                v.__saturation_field,
                                "mousedown",
                                a
                            ),
        ...
        function (e, t, n) {
            ...
            function a(e, t, n) {
                if (
                    ...
                    var o = function (t) {
                        if (
                            G["default"].isNumber(n.__min) &&
                            G["default"].isNumber(n.__max)
                        ) {
                            var o =
            ...
            function f(e) {
                ...
                e.load && e.load.remembered
                    ? G["default"].each(e.load.remembered, function (t, n) {
                          d(e, n, n === e.preset);
                      })
                    : d(e, J, !1),
                    ...
                    q &&
                        !(function () {
                            ...
                            (o.style.display = "block"),
                                "true" ===
                                    localStorage.getItem(u(e, "isLocal")) &&
            ...
            function h(e, t) {
                var n = {};
                return (
                    G["default"].each(e.__rememberedObjects, function (o, i) {
                        var r = {},
                ...
                oe = function ie(e) {
                    ...
                    (this.domElement = document.createElement("div")),
                        ...
                        G["default"].isUndefined(o.parent) &&
                            ...
                            ne.push(this),
                        (o.resizable =
                            G["default"].isUndefined(o.parent) && o.resizable),
                        o.autoPlace &&
                            G["default"].isUndefined(o.scrollable) &&
                            (o.scrollable = !0);
                    var r =
                            q &&
                            "true" === localStorage.getItem(u(this, "isLocal")),
                        a = void 0;
                    if (
                    ...
                    o.autoPlace &&
                        ...
                        (a = function () {
                            q &&
                                "true" ===
                                    localStorage.getItem(u(n, "isLocal")) &&
                                localStorage.setItem(
                                    u(n, "gui"),
                    ...
                    onResize: G["default"].debounce(function () {
                        ...
                        if (e.scrollable) {
                            ...
                            G["default"].each(e.__ul.childNodes, function (t) {
                                ...
                                window.innerHeight - t - Q < n
                                    ? (z["default"].addClass(
                                          e.domElement,
                                          oe.CLASS_TOO_TALL
                                      ),
                                      (e.__ul.style.height =
                                          window.innerHeight - t - Q + "px"))
                                    : (z["default"].removeClass(
                                          e.domElement,
                                          oe.CLASS_TOO_TALL
                                      ),
                        ...
                        (e.prototype.layout = function () {
                            (this.domElement.style.left =
                                ...
                                (this.domElement.style.top =
                                    ...
                                    a["default"].getHeight(this.domElement) /
                                        2 +
                                    "px");
                        }),
                        e
